                  ...
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="p-4 text-center align-middle whitespace-nowrap text-sm font-semibold border-gray-300 rounded-bl-lg">
                      <button
                        ...
                        type="button"
                        className="text-white bg-yellow-400 hover:bg-yellow-600 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
                      >
                        <MdEdit size={24}/>
                      </button>
                    </td>
